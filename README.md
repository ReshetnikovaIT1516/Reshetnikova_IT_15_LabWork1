...
Что бы вернуть только дробную часть числа х, я использую INT=(int)x, который отбрасывает дробную част о числа. Если из числа x вычесть INT, мы получим только дробную  часть числа х.
## Задача 3
### Текст задачи
Букву в число.
